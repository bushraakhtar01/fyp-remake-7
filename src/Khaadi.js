...
class Khaadi extends Component{
  ...
  async componentDidMount(){
    if(!sessionStorage.getItem("userData")){
      ...
      const url="https://pehnaway78.000webhostapp.com/api/post/read.php";
...
submitHandler = e  =>{
 ...
 formData.append("size_id", this.state.size_id);
  ...
  axios.post('https://pehnaway78.000webhostapp.com/api/post/update.php',formData,config)
  .then(response=>{
...
<img className="adminimages px-2 pb-4" src={"https://pehnaway78.000webhostapp.com/api/post/" + brand.image}></img>
